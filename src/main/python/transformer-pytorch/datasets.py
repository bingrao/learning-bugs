...
class TranslationDatasetOnTheFly:
    ...
    def __init__(self, phase, limit=None):
        ...
        if phase == 'train':
            source_filepath = join(BASE_DIR, 'data', 'bug-fixes', 'small', 'train', 'src-train.txt')
            target_filepath = join(BASE_DIR, 'data', 'bug-fixes', 'small', 'train', 'tgt-train.txt')
        elif phase == 'val':
            source_filepath = join(BASE_DIR, 'data', 'bug-fixes', 'small', 'eval', 'src-val.txt')
            target_filepath = join(BASE_DIR, 'data', 'bug-fixes', 'small', 'eval', 'tgt-val.txt')
        else:
